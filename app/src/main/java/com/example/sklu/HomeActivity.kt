...
class HomeActivity : AppCompatActivity() {
    ...
    fun getData() {
        ...
        Log.e("RESULT===SIZE", "getData: ${bool!!.size}", )
        if (bool!!.size == 0) {
        ...
        Log.e("RESULT===SIZE", "getData: ${clos!!.size}", )
        if(clos!!.size == 0){
            db2.addClo(Clo("Computation 1","0","E", "all,CPL-8,CPL-11,CPL-19,CPL-29,", id))
            ...
            db2.addClo(Clo("Industry Internship","0","E", "all,CPL-3,CPL-4,CPL-5,CPL-6,CPL-7,CPL-8,CPL-9,CPL-10,CPL-11,CPL-12,CPL-13,CPL-14,CPL-15,CPL-16,CPL-18,CPL-19,CPL-20,CPL-22,CPL-23,CPL-24,CPL-25,CPL-26,CPL-27,CPL-28,CPL-29,CPL-30,CPL-31,CPL-32,CPL-33", id))
            ...
            db2.addClo(Clo("Computer And Society","0","E", "all,CPL-3,CPL-17,CPL-20,", id))
    ...
    fun goToClo(type: String){
        ...
        Log.e("RESULT===SIZE1", "getData: ${clos!!.size}", )
        val fragmentTransaction = fragmentManager.beginTransaction()
